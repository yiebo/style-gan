...
g_optimizer = torch.optim.Adam(generator.parameters(), lr=0.001, betas=(0., 0.999))
d_optimizer = torch.optim.Adam(discriminator.parameters(), lr=0.001, betas=(0., 0.999))
gamma = 0.99
